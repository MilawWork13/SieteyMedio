...
<body>
    <section class="overflow-hidden">
        ...
        <div class="row">
            ...
            <div class="row">
                <button type="submit" class="btn btn-success position-relative col-sm-2 top-50 start-50 translate-middle my-3" id="startGame">¡JUGAR!</button>
                <form action="/WebProject/index.jsp" method="GET">
                    <button class="btn btn-secondary col-md-1 position-relative col-sm-2 my-4 top-50 start-50 translate-middle ">INICIO</button>
                </form>
            </div>
        </div>
    </section>
